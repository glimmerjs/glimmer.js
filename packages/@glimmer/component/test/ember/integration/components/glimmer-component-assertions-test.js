...
const GLIMMERJS_ONLY_FIELDS = ['bounds', 'element', 'debugName'];

const GLIMMERJS_ONLY_METHODS = ['didInsertElement', 'didUpdate'];

module('Integration | Component | @glimmer/component', function(hooks) {
  setupRenderingTest(hooks);

  for (const element of GLIMMERJS_ONLY_FIELDS) {
  ...
  for (const element of GLIMMERJS_ONLY_METHODS) {
