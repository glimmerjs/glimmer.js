...
import { ComponentCapabilities, ProgramSymbolTable, Option } from '@glimmer/interfaces';
...
export default class ComponentDefinition implements IComponentDefinition {
  ...
  constructor(public name: string, public manager: ComponentManager, public ComponentClass: Option<ComponentFactory>, public handle: number) {
    this.state = {
      name,
      capabilities,
      ComponentClass,
